...
class Solution:
    def maximum_area_histogram(self, row):
        ...
        area: int = 0  # Initialize area with current top
    ...
    def maxRectangle(self, A):
        ...
        result = self.maximum_area_histogram(A[0])
        ...
        for i in range(1, len(A)):
            ...
            result = max(result, self.maximum_area_histogram(A[i]))
